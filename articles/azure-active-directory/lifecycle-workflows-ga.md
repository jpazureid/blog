...
新しいライフサイクル ワークフローの機能強化により、アクセス パッケージの割り当てリクエストを行ったり、 企業のロゴやドメインを含む独自のブランドでカスタマイズされたメールを作成したり、カスタムされた件名、本文、言語を追加受信者を CC に追加することができるようになりました。
