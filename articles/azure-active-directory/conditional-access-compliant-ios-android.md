...
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| A                       | 準拠済み？                                                                                                         |
| B                       | サポートされたブラウザを使用している？                                                                                                                 |
| C                       | Edge Chromium を使用している場合、ブラウザにサインインできている？                                                                               |
| D                        | 旧 Edge を利用している場合                                                         |
| E                      | 証明書を提示できていない |
...
OS によってサポートされるブラウザーは異なるため、ご利用の端末の OS でサポートされているブラウザを利用されているかご確認をお願いします。
...
## C. Edge Chromium を使用している場合、ブラウザにサインインしている？

Microsoft Edge Chromium を利用してデバイス情報を提示するためには、ブラウザにサインインしている必要があります。
...
iOS / Android がデバイス情報を提示する仕組みは、ブラウザ アクセスの場合と、クライアント アプリの場合で異なります。

<br>

ブラウザ アクセスの場合は、iOS も Android も Azure AD に証明書を提示することでデバイス情報を渡します。
...
iOS / Android を使用したブラウザ アクセスは、上記のように証明書を使用したデバイス情報の提示が可能となります。
...
アプリの実装によっては、ブラウザを経由してデバイス情報を提示する場合もあるため、その場合は Microsoft Authenticator  を用いずにデバイス情報を提示可能です。
