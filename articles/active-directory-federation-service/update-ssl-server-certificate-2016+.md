...
また、Powershell のコマンドが失敗する場合には、[こちら](https://jpazureid.github.io/blog/active-directory-federation-service/update-ssl-server-certificate-netsh/)の手順でも更新できますので、必要に応じて参照ください。
