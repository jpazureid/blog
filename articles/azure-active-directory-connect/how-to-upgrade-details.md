...
>
> その他、プロキシを使用されている環境では、2.4.18.0 以降のでは、構成ウィザードが machine.config ではなく Internet Options の設定を参照するため、Windows の [検索] で "Internet options" で検索し、[接続] タブにある Lan Settings にプロキシの設定があることを併せてご確認ください。
> 
