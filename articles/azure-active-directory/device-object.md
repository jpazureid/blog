---
title: デバイス オブジェクトの属性の確認方法と各確認方法で表示される内容の比較
...
1. ブラウザーから [Microsoft Entra 管理センター](https://entra.microsoft.com/) にアクセスしてサインインします。
...
![](./device-object/device-details-in-entra-admin-center.png)
...
![](./device-object/device-details-in-graph-explorer.png)
...
![](./device-object/device-details-in-graph-powershell.png)
...
![表1. デバイス属性と、Microsoft Entra 管理センター、Graph Explorer、Microsoft Graph PowerShell で確認できる属性の対応表](./device-object/comparison-table-of-device-objects.png)
...
![表2. デバイスのフィルターで利用可能な属性と各確認方法で確認できる属性の対応表](./device-object/table-of-device-objects-available-for-filtering-devices.png)

※ mdmAppId は [該当の ME-ID デバイスが MDM 管理されている] 場合、MDM 管理アプリケーションのアプリケーション ID 表示されますので、以下の表 3 に対応表をまとめました。

![表3. MDM と mdmAppId の対応表](./device-object/table-of-mdm-and-mdmappid.png)
