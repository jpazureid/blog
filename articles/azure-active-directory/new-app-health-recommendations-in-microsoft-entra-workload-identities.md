...
![推奨設定の画面](./public-preview-token-protection-for-sign-in-sessions/public-preview-token-protection-for-sign-in-sessions.png)
...
上記画面を確認し、最善の対応を行うには、以下の手順を実施ください:
 ...
 Microsoft Graph を使用してアプリの正常性に関する推奨事項を操作したい場合は、こちらのドキュメントを参照してください。
