...
タイトル : Office 365 への TLS 1.2 の実装に対する準備  
URL : https://support.microsoft.com/ja-jp/help/4057306/preparing-for-tls-1-2-in-office-365  
...
タイトル : Azure AD Connect アップグレード手順  
...
タイトル : マイクロソフト セキュリティ アドバイザリ 2868725  
URL : https://technet.microsoft.com/ja-jp/library/security/2868725.aspx  
...
タイトル : インストールされている .NET Framework バージョンを確認する  
...
タイトル : Update to add support for TLS 1.1 and TLS 1.2 in Windows Server 2008 SP2 and Windows Embedded POSReady 2009  
URL : https://support.microsoft.com/en-us/help/4019276/update-to-add-support-for-tls-1-1-and-tls-1-2-in-windows  
...
タイトル : マイクロソフト セキュリティ アドバイザリ 2960358  
URL : https://technet.microsoft.com/library/security/2960358  
...
タイトル : セキュリティ更新プログラム 2960358 をインストールした後に、Internet Explorer でホストされるマネージ コントロールを含むアプリケーションとノータッチ デプロイメントが正しく機能しないことがある  
URL : https://support.microsoft.com/ja-jp/kb/2978675  
