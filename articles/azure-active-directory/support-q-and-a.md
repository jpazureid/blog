...
なお、ご利用のオンプレミス環境において、たとえば Windows Server が関係する障害の原因究明調査については、[マイクロソフト ユニファイド契約](https://www.microsoft.com/ja-jp/microsoft-unified)に付随するサポート、オンプレミスもカバーした [パートナー向け Premier Support](https://partner.microsoft.com/ja-jp/support/microsoft-services-premier-support)、[プロフェッショナル サポート](https://learn.microsoft.com/ja-jp/services-hub/sfbus/support-for-business/access-id-prof-support)などで承っております。
